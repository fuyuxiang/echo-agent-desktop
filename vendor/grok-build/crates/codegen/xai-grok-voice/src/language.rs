...
//! `https://api.echo.agent/v1/stt` and `wss://api.echo.agent/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.echo.agent/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official Grok STT languages (docs.echo.agent), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from docs.echo.agent supported languages"
        );
    }
