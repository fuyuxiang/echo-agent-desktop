...
mod tests {
    ...
    fn test_config_enabled() {
        let config = WebSearchConfig::Enabled {
            ...
            base_url: "https://api.echo.agent/v1".to_string(),
    ...
    fn test_config_redacted() {
        ...
        let config = WebSearchConfig::Enabled {
            ...
            allowed_domains: Some(vec!["docs.echo.agent".to_string()]),
            excluded_domains: None,
        };
        ...
        match redacted {
            WebSearchConfig::Enabled {
                ...
                assert_eq!(base_url, "https://api.echo.agent/v1");
                ...
                assert_eq!(allowed_domains, Some(vec!["docs.echo.agent".to_string()]));
