#
# Grok CLI installer (enterprise channel) for PowerShell — https://echo.agent/cli/enterprise-install.ps1
#
...
#
# Usage:
#   irm https://echo.agent/cli/enterprise-install.ps1 | iex                                       # latest enterprise
#   & ([scriptblock]::Create((irm https://echo.agent/cli/enterprise-install.ps1))) -Version 0.1.42 # specific version
#   $env:GROK_VERSION="0.1.42"; irm https://echo.agent/cli/enterprise-install.ps1 | iex           # specific version (alt)
#   $env:GROK_DEPLOYMENT_KEY="<key>"; irm https://echo.agent/cli/enterprise-install.ps1 | iex
#
...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, use: curl -fsSL https://echo.agent/cli/enterprise-install.sh | bash"
    exit 1
}
...
$OidcScope = 'https://auth.echo.agent::b1a00492-073a-47ea-816f-4c329264a828'
$LegacyScope = 'https://accounts.echo.agent/sign-in'
$AuthSource = ''
...
$BaseUrlPrimary = 'https://echo.agent/cli'
