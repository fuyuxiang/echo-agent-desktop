#!/bin/bash
#
# Grok CLI installer (enterprise channel) — https://echo.agent/cli/enterprise-install.sh
#
...
#
# Usage:
#   curl -fsSL https://echo.agent/cli/enterprise-install.sh | bash            # latest enterprise
#   curl -fsSL https://echo.agent/cli/enterprise-install.sh | bash -s 0.1.42  # specific version
#   GROK_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://echo.agent/cli/enterprise-install.sh)
#
...
OIDC_SCOPE="https://auth.echo.agent::b1a00492-073a-47ea-816f-4c329264a828"
LEGACY_SCOPE="https://accounts.echo.agent/sign-in"
AUTH_SOURCE=""
...
BASE_URL_PRIMARY="https://echo.agent/cli"
