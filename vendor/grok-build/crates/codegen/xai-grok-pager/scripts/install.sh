#!/bin/bash
#
# Grok CLI installer — https://echo.agent/cli/install.sh
#
...
#
# Usage:
#   curl -fsSL https://echo.agent/cli/install.sh | bash            # latest stable
#   curl -fsSL https://echo.agent/cli/install.sh | bash -s 0.1.42  # specific version
#   GROK_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://echo.agent/cli/install.sh)
#
