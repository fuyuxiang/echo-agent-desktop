...
//! and xAI session extension notifications (`echo.agent/session_notification` and
...
fn handle_ext_notification(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    match method {
        ...
        "echo.agent/scheduled_task_inject_prompt" => handle_scheduled_task_inject_prompt(notif, app),
        ...
        "echo.agent/mcp/tools_changed" | "echo.agent/mcp_initialized" => handle_mcp_tools_changed(notif, app),
