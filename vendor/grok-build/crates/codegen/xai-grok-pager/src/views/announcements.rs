...
mod tests {
    ...
    fn session_hide_keys_cover_live_criticals_and_promos_only() {
        ...
        let list = vec![
            ...
            promo("promo-1", "upsell", Some(("Go", "https://echo.agent"))),
            expired_promo,
        ];
    ...
    fn first_promo_selection_filters_severity_and_hidden() {
        let list = vec![
            ...
            promo("p-a", "A promo", Some(("Go", "https://echo.agent"))),
    ...
    fn first_session_announcement_prefers_critical_over_promo() {
        let list = vec![
            promo("p", "upsell", Some(("Go", "https://echo.agent"))),
            RemoteAnnouncement {
                id: Some("c".into()),
                severity: Some("critical".into()),
    ...
    fn render_promo_row_non_dismissible_shows_configured_caption() {
        let mut ann = promo("p", &"M".repeat(60), Some(("Go", "https://echo.agent")));
        ...
        let mut bare = promo("p", &"M".repeat(60), Some(("Go", "https://echo.agent")));
    ...
    fn usable_cta_caption_trims_and_never_resurrects_unusable_cta() {
        let mut p = promo("p", "msg", Some(("Go", "https://echo.agent")));
    ...
    fn promo_cta_returns_label_and_pinned_flag() {
        let mut pinned = promo("p", "msg", Some(("Upgrade Account", "https://echo.agent/promo")));
        ...
        let dismissible = [promo("d", "msg", Some(("Go", "https://echo.agent")))];
    ...
    fn promo_cta_target_yields_to_critical_slot_owner() {
        let promo_ann = promo("p", "upsell", Some(("Go", "https://echo.agent/promo")));
        ...
        assert_eq!(
            ...
            Some((Some("p"), "https://echo.agent/promo"))
        );
    ...
    fn usable_cta_rejects_unsafe_schemes() {
        ...
        for good in ["https://echo.agent/promo", "http://echo.agent/promo"] {
    ...
    fn render_promo_row_button_and_hide_affordances() {
        let mut ann = promo(
            "p",
            "New promo",
            Some(("Get SuperGrok", "https://echo.agent/grok")),
        );
        ann.cta.as_mut().unwrap().caption = Some("or use Ctrl+O".into());
        let anns = [ann];
    ...
    fn render_promo_row_hover_styles() {
        let anns = [promo("p", "msg", Some(("Go", "https://echo.agent")))];
        let area = Rect::new(0, 0, 80, 1);
        let theme = Theme::current();
    ...
    fn render_promo_row_narrow_width_drops_hide_cta_text() {
        let anns = [promo("p", "msg body", Some(("Go", "https://echo.agent")))];
