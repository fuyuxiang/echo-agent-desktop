...
pub(crate) const PRIVACY_BANNER_TERMS_URL: &str = "https://echo.agent/legal/terms-of-service";
pub(crate) const PRIVACY_BANNER_POLICY_URL: &str = "https://echo.agent/legal/privacy-policy";
