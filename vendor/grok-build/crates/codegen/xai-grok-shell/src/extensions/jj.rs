...
pub(crate) async fn try_handle(
    ...
    match method {
        ...
        "echo.agent/git/current_commit" => Some(to_ext_response(jj::current_commit(git_root).await)),
        ...
        "echo.agent/git/stage/content" | "echo.agent/git/unstage" => Some(to_ext_response(Ok(Empty {}))),
