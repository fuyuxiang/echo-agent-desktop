...
/// See https://docs.echo.agent/developers/rate-limits#rate-limit-tiers
pub const RATE_LIMITED_USER_MESSAGE_API_KEY: &str = "You\u{2019}ve hit your team\u{2019}s API rate limit. Ask a team admin to purchase more credits for higher limits, or try again later. See https://docs.echo.agent/developers/rate-limits#rate-limit-tiers";
...
mod tests {
    ...
    fn rate_limited_fallback_oauth_vs_api_key() {
        ...
        assert!(
            RATE_LIMITED_USER_MESSAGE_API_KEY
                .contains("https://docs.echo.agent/developers/rate-limits#rate-limit-tiers")
        );
    ...
    fn format_rate_limited_surfaces_nonempty_server_detail() {
        ...
        let team = "resource-exhausted: Too many requests for team abc. See https://console.echo.agent/team/default/rate-limits.";
