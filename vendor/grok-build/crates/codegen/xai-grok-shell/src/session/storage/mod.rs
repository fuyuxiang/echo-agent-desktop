...
pub(crate) const XAI_SESSION_UPDATE_METHOD: &str = "_echo.agent/session/update";
...
pub(crate) struct SessionUpdateEnvelope {
    ...
    /// Either "session/update" for ACP or "_echo.agent/session/update" for xAI extensions.
    pub method: String,
