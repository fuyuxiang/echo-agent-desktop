...
pub const XAI_API_BASE_URL_DEFAULT: &str = "https://api.echo.agent/v1";
...
impl Config {
    ...
    /// Resolve whether to use grok's default OAuth2 (xAI auth.echo.agent).
    ///
...
pub struct ModelEntryConfig {
    ...
    /// The base URL of the model. e.g. "https://api.echo.agent/v1"
    pub base_url: String,
