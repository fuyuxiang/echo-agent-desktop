...
Terminal UI (TUI) for EchoAgent Build. Provides the interactive full-screen interface
...
- [Hook Examples](../echo-agent-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`echo-agent-hooks`)](../echo-agent-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`echo-agent-plugin-marketplace`)](../echo-agent-plugin-marketplace/) — marketplace source loading, scanning, and install
