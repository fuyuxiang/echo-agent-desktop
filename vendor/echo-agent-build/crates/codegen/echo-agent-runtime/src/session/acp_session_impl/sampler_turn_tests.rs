use echo_agent_sampling_types::{SearchDateBound, ToolOverrides, WebSearchOptions, XSearchOptions};
...
fn inherited_cutoff_agrees_with_the_wire_echo_so_the_two_implementations_cannot_drift() {
    use echo_agent_sampling_types::{HostedTool, apply_tool_overrides};
