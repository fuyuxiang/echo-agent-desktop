...
impl echo_agent_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // EchoAgentBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::echo_agent_build::read_file::ReadFileTool;
